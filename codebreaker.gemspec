...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Karpenko Yaroslav']
  spec.email         = ['yaroslavkarpenko1505@gmail.com']

  spec.summary       = 'Write a short summary, because RubyGems requires one.'
  spec.description   = 'Write a longer description or delete this line.'
  spec.homepage      = 'https://github.com/YaroslavKarpenko'
  spec.license       = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/YaroslavKarpenko'
